...
/**
 * Repository interface for Author entity operations using Spring Data JPA.
 * 
 * <p>This interface demonstrates Spring Data JPA repository concepts:</p>
 * <ul>
 *   <li><strong>JpaRepository extension</strong>: By extending JpaRepository, this interface automatically
 *       provides basic CRUD operations (Create, Read, Update, Delete) for the Author entity without
 *       requiring any implementation code.</li>
 *   <li><strong>Generic parameters</strong>: JpaRepository&lt;Author, Long&gt; specifies that this repository
 *       works with Author entities and uses Long as the primary key type.</li>
 ...
 * <ul>
 *   <li><strong>save(Author entity)</strong>: Saves or updates an author</li>
 *   <li><strong>findById(Long id)</strong>: Finds an author by ID</li>
 *   <li><strong>findAll()</strong>: Returns all authors</li>
 *   <li><strong>delete(Author entity)</strong>: Deletes an author</li>
 *   <li><strong>count()</strong>: Returns the total number of authors</li>
 *   <li><strong>existsById(Long id)</strong>: Checks if an author exists by ID</li>
 *   <li>And many more...</li>
 * </ul>
 * 
